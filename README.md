...
| **Real GDP** | (macro, where used) | Log of real GDP at country level. Source: Eurostat. | Macroeconomic activity affects labour demand across industries. Inclusion controls for country-level business-cycle and growth effects that could correlate with robot adoption. |
