'''
Equation 4: Bucket Heterogeneity with Institutional Moderation
...
Usage:
  python code/6-equation4-bucket-heterogeneity-coordination.py 2 --moderator ud --sample full
  python code/6-equation4-bucket-heterogeneity-coordination.py 2 --moderator coord --sample common
  python code/6-equation4-bucket-heterogeneity-coordination.py 2 --moderator adjcov --sample common
'''
