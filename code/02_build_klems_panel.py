...
Buckets: 5 theory-driven industry groups (imported from _klems_utils)
'''
...
from _klems_utils import NACE_TO_BUCKET, BUCKET_NAMES
...
def main():
    ...
    # Bucket assignment (imported from _klems_utils, single source of truth)
