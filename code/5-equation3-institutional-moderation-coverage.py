'''
Equation 3: Institutional Moderation – Coverage (restricted sample)
...
Usage:
  python code/5-equation3-institutional-moderation-coverage.py 2 --moderator adjcov --sample common
