...
Usage:
  python code/secondary/legacy_klems/06_klems_adjcov_moderation.py 2 --moderator adjcov --sample common
  python code/secondary/legacy_klems/06_klems_adjcov_moderation.py 3   # coverage plot only
'''
