...
Target panel: legacy KLEMS overlap sample, 1995-2019.
'''
...
# ═══════════════════════════════════════════════════════════════════
# IFR industry_code -> KLEMS nace_r2_code (from 02_build_klems_panel.py)
IFR_TO_NACE = {
...
if cleaned is not None and "nace_r2_code" in cleaned.columns:
    ...
    warn("cleaned_data.csv not found — run 02_build_klems_panel.py first for eq4/eq5 usability")
