...
CLI flags:
  ...
  --trends none                     (default: none; bucket variants archived)

Usage:
  python code/secondary/legacy_klems/05_klems_institution_moderation.py 2 --moderator coord --sample common
  python code/secondary/legacy_klems/05_klems_institution_moderation.py 2 --moderator adjcov --sample common
  python code/secondary/legacy_klems/05_klems_institution_moderation.py 2 --moderator ud --sample full
'''
